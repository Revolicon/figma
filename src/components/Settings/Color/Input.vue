<template>
  <div class="input">
    ...
    <input
      ...
      @focus="$event.currentTarget.select()"
      @blur="opacityHandler(input.opacity)"
      @keydown.enter="$event.currentTarget.blur()"
...
<script setup>
  ...
  const colorNameToHex = (colorName) => {
    ...
    if (typeof colorList[colorName.toLowerCase()] != 'undefined') return colorList[colorName.toLowerCase()]
